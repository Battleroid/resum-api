...
func JobsResponse(w http.ResponseWriter) {
	...
	var jobs = []Job{
		{Title: "Web Application Programmer", StartDate: "March 2012", EndDate: "January 2014", Location: "Savannah, GA", Employer: "Armstrong State University", Description: "Support campus constituents and other IT teams with strong emphasis on application development", Accomplishments: []string{"Developed a data visualization application for displaying project management and tracking dashboards.", "Developed a service status dashboard that displays current status of a system service and sends out a tweet when updated.", "Developed a searchable employee & department directory that is updated by parsing a Google Spreadsheet and is updated via cron."}},
